...
namespace SagaraSoftware.ZipCodeUtil
{
    ...
    public class ZipCodeUtil
    {
        ...
        /// <returns>If a matching ZIP Code was found in the database, a <see cref="SagaraSoftware.ZipCodeUtil.Location" />
        ///  object containing information about that ZIP Code.  Otherwise, returns null.</returns>
        public static Location LookupByCityZipCode(String inZipCode, string inCity)
        {
            Debug.Assert(null != inZipCode);
            Debug.Assert(String.Empty != inZipCode);
            ...
            try
            {
                ...
                if (null != db)
                    loc = db.DoLookupByCityZipCode(inZipCode, inCity);
            }
            catch (Exception e)
            {
                // JonJon: Need to implement logging.
        ...
        /// <returns>If a matching ZIP Code was found in the database, a <see cref="SagaraSoftware.ZipCodeUtil.Location" />
        ///  object containing information about that ZIP Code.  Otherwise, returns null.</returns>
        public static Location LookupByCityStateZipCode(String inZipCode, string inCity, string inState)
        {
            Debug.Assert(null != inZipCode);
            Debug.Assert(String.Empty != inZipCode);
            ...
            try
            {
                ...
                if (null != db)
                    loc = db.DoLookupByCityStateZipCode(inZipCode,inCity,inState);
            }
            catch (Exception e)
            {
                // JonJon: Need to implement logging.
