...
namespace SagaraSoftware.ZipCodeUtil
{
	...
	public interface IDataProvider
	{
        ...
        Location DoLookupByCityStateZipCode(string inZipCode, string inCity, string inState);
		LocationInRadius[] GetLocationsWithinRadius (Location inRefLoc, RadiusBox inBounds);
        Location DoLookupByCityZipCode(string inZipCode, string inCity);
	}
	...
	public class DataProvider
	{
		...
		{
			string strProviderType = Globals.sProvider;
