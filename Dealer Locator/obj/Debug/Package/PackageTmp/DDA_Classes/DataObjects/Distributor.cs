...
using System.Text;
using System.Data;
using Dealer_Locator.DDA.DataAccess;
...
namespace Dealer_Locator.DataObjects
{
    class Distributor
    {
        ...
        {
            DataSet dsDI = Dealer_Locator.DDA.DataAccess.Distributor_da.GetDistributorInformation(p_distID);
            ...
            _Zip = Convert.ToInt32(dsDI.Tables[0].Rows[0]["fk_ZipID"]);
        ...
        public static void GetEmails(int p_distID)
        {
            ...
            _emails.Clear();
            ds = Dealer_Locator.DDA.DataAccess.Distributor_da.GetEmailAddresses(p_distID);
        ...
        public static void GetContacts(int p_distID)
        {
            ...
            _contacts.Clear();
            ds = Dealer_Locator.DDA.DataAccess.Distributor_da.GetContacts(p_distID);
        ...
        private class DG_Dist
        {
            ...
            public DG_Dist(ref DataRow dr)
            {
                ...
                DataSet ds;
                ds = Dealer_Locator.DDA.DataAccess.Contract_da.GetDistributorContract(Convert.ToInt32(dr["pk_DistributorID"].ToString()));
                ...
                try
                {
                    ...
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        for (i = 0; i < ds.Tables[0].Rows.Count; i++)
                        {
                            if (Convert.ToInt32(ds.Tables[0].Rows[i]["fk_ContractID"].ToString()) == Dealer_Locator.DataObjects.AppData.CurrentContract.ContractID)
                            {
                ...
                dr["srvcrep"] = Convert.ToString(this.associate);
                    ...
                    srvRepCount = Dealer_Locator.DataObjects.Distributor.GetRepresentativeCount("Service", id);
                    terrRepCount = Dealer_Locator.DataObjects.Distributor.GetRepresentativeCount("Territory", id);
