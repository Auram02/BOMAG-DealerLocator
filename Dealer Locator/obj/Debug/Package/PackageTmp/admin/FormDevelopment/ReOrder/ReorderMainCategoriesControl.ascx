...
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
  ...
  SelectCommand="SELECT * FROM [DL.MainCategory] WHERE disable=0 ORDER BY position ASC"
                ...
                <td valign="middle" style="border-left: none;">
                    ...
                    <br />
                                        ...
                                        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" InsertMethod="Insert"
                                            OldValuesParameterFormatString="original_{0}" SelectMethod="GetData_nonDisabled" TypeName="Dealer_Locator.DA.MainCategoryTDSTableAdapters.DL_MainCategoryTableAdapter"
