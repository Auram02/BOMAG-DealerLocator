<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EmailControl.ascx.cs" Inherits="Dealer_Locator.admin.Admin.HeavyDistributorEmailControl" %>
<font size="4" style="font-weight:bold;" color="#3D51AA">HEAVY DISTRIBUTOR E-MAIL SETUP</font>
<br /><br />
                        ...
                        <table cellpadding="3">
                            <tr>
                                <td class="dlHeader" style="width: 788px">
                                    Heavy Distributor Email Address</td>
                            </tr>
                            <tr>
